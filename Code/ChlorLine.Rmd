...
There is migration happening, however, not at a measurable trend, since the data has very few points and is very sparse.

In all temperature settings, values started low, and increased later on - not exactly with respect to time, but still, high values were not found at the start of the sampling period.
