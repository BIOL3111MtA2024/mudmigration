...
```
<<<<<<< HEAD
```{r geom_smooth_solidline}
# same graph but with a solid line instead, doesn't change anything - just wanted to see what is aesthetically better
vert_migration_wide |>
  ggplot() +
  geom_point(aes(x = ToD, y = TopBottomRatio), alpha = 0.7) +
  geom_smooth(aes(x = ToD, y = TopBottomRatio), method = "lm", color = "red", linetype = "solid", linewidth = 1.2) + 
  facet_grid(cols = vars(Temp_C)) +
  labs(
    x = "Time of Day", 
    y = "Top to Bottom Ratio", 
...
=======
>>>>>>> b281a7a54afa348452f34db003520f0bc85ab224
...
# Nested Regression
<<<<<<< HEAD
We completed a nested regression for each temperature setting to determine if there is any significant slope/trend in our data.
```{r nested_regression}
=======
>>>>>>> 3a3b90ff0638e17233f0c14ebaa800a441d5c676
