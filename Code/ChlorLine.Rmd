...
At 20°C ratios are generally lower, slightly below 2, with one exceeding 2 (at 11 am).
...
At 15°C, the data shows the highest variation with the most extreme values out of the three temperatures, indicating that at 15°C there is greater concentration of chlorophyll at the top surface compared to the bottom, consequently, greater diatom migration. Temperatures 20°C and 23°C have less pronounced variations, suggesting that these conditions lead to a more balanced chlorophyll distribution between the top and bottom surfaces.
