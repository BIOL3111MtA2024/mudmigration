...
ggplot(cell_count_data, aes(x = Light, y = CellCount, fill = Light)) +
  ...
  labs( 
       ...
       title = "Cell Count faceted per temperature, coloured by light level") +
...
ggplot(top_bottom_ratio_data, aes(x = Patch, y = Ratio, fill = Light)) +
  ...
  labs(
    ...
    title = str_wrap("Top-to-bottom ratio of cell count, faceted by temperature and coloured by light.")
  ) +
  facet_grid(~ Temp_C) + 
  theme_minimal() +
  theme(
