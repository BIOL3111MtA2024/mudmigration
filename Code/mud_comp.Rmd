...
## Graph without combining cell counts by light
```{r}
# # Plot Cell Volumes with Colors Based on Light
# merged_data |>
#   ggplot() +
#   geom_histogram(aes(x = MaxDim_Total, fill = Light), bins = 30, color = "black", position = "stack") + 
#   labs(
...
#   scale_fill_brewer(palette = "Set1") +  # Use a Brewer palette for clear colors
#   theme_minimal() +
#   theme(
#     axis.text.x = element_text(angle = 45, hjust = 1), 
#     axis.title.x = element_text(size = 12),
#     legend.position = "bottom"  # Move the legend below the plot for clarity
#   )
